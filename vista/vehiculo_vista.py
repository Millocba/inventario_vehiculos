...
class VehiculoVista(tb.Window):
    def __init__(self, controlador):
        ...
        self.label_kms.grid(row=1, column=2, sticky="e", padx=5, pady=5)
        self.entry_kms.grid(row=1, column=3, sticky="ew", padx=5, pady=5)
        self.check_0km.grid(row=1, column=4, sticky="w", padx=5, pady=5)
        ...
        # === FILA 4: Color, Ubicación, Observaciones ===
        ...
        self.entry_observaciones = tb.Entry(frame, font=("Segoe UI", 11))

        self.label_color.grid(row=4, column=0, sticky="e", padx=5, pady=5)
        self.entry_color.grid(row=4, column=1, sticky="ew", padx=5, pady=5)
        self.label_ubicacion.grid(row=4, column=2, sticky="e", padx=5, pady=5)
        self.entry_ubicacion.grid(row=4, column=3, sticky="ew", padx=5, pady=5)
        self.label_observaciones.grid(row=4, column=4, sticky="e", padx=5, pady=5)
        self.entry_observaciones.grid(row=4, column=5, sticky="ew", padx=5, pady=5)
        ...
        self.entry_busqueda.grid(row=6, column=3, sticky="ew", padx=5, pady=10)
        self.boton_buscar.grid(row=6, column=4, sticky="ew", padx=5, pady=10)
